...
proc create_root_design { parentCell } {
  ...
  set axis_fifo_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_fifo:1.0 axis_fifo_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_fifo_0/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_fifo_0_M00_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_fifo_0/M00_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_fifo_0_M00_AXIS] [get_bd_intf_pins axis_fifo_0/M00_AXIS] [get_bd_intf_pins system_ila/SLOT_0_AXIS]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_fifo_0_M00_AXIS]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_TRIGGER_OUT_0 [get_bd_intf_pins processing_system7_0/TRIGGER_OUT_0] [get_bd_intf_pins system_ila/TRIG_IN]
